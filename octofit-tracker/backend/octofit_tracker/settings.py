...
SECRET_KEY = 'django-insecure-bg3gwncu^_(7)-dd#f2p%j11kk@%ex6ab!6bzm&f!o=t_qy&q!'
...
if CODESPACE_NAME:
    ...
    CORS_ALLOWED_ORIGINS = [CODESPACE_ORIGIN, "http://localhost:8000", "http://127.0.0.1:8000"]
else:
